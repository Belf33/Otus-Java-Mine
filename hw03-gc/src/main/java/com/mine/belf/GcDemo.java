...
//        int loopCounter = 500;
        ...
        ObjectName name = new ObjectName("com.mine.belf:type=Benchmark");
    ...
    private static void switchOnMonitoring() {
        ...
        AtomicInteger youngCount = new AtomicInteger();
        Integer oldDuration =  0;
        AtomicInteger youngDuration = new AtomicInteger();
        ...
        for (GarbageCollectorMXBean gcbean : gcbeans) {
            ...
            NotificationListener listener = (notification, handback) -> {
                if (notification.getType().equals(GarbageCollectionNotificationInfo.GARBAGE_COLLECTION_NOTIFICATION)) {
                    ...
                    if(gcName.contains("Young Generation")) {
                        youngCount.getAndIncrement();
                    }
                    else if(gcName.contains("Old Generation")) {
        ...
        System.out.println("Young count: " + youngCount);
    }
